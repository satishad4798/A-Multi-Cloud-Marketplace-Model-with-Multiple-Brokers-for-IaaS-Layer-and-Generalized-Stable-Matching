 ...
 * 
 */
package cloud_assinment_stable_matching;
import java.util.*;
/**
 * @author satishad47
 *
 */
public class broker_cloud {
	  ...
	  static void  show_vm_allotments(int[][] vm_alloted_to_broker,int c_count,int b_count,int[] broker_demand)
	  {
	    ...
	    public static void main(String args[]){  
            ...
            //taking inputs
            System.out.println("1.use default valus to run program 2.manual user inputs");
            ...
            //showing price offered by cloud to broker
            ...
            //creating cloud preference list 
            ...
            //code for broker making request
            if(choice2==1){
